...
set_permissions() {
  ...
  # set_perm $UNITY/system/lib/libart.so 0 0 0644
	...
	set_perm $UNITY/service.sh 0 0 0755
	set_perm $UNITY/post-fs-data.sh 0 0 0755
	set_perm_recursive $UNITY/system/fonts 0 0 0755 0644
	set_perm_recursive $UNITY/system/bin 0 0 0755 0755
	set_perm_recursive $UNITY/system/xbin 0 0 0755 0755
	set_perm_recursive $UNITY/system/priv-app 0 0 0755 0644
}
